 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called coin (http://www.coinbi.net/),
	...
	try {
		...
		if (SysCfg().IsArgCount("-?") || SysCfg().IsArgCount("--help")) {
			...
			std::string strUsage = _("Coin Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n\n"
					+ _("Usage:") + "\n" + "  Coin [options]                     " + _("Start Coin Core Daemon")
