...
//
#ifndef COIN_BASE58_H_
#define COIN_BASE58_H_
...
class CCoinAddress: public CBase58Data {
 public:
	...
	CCoinAddress(const string& strAddress) {
...
template<typename K, int Size, emBase58Type Type> class CCoinExtKeyBase: public CBase58Data {
 public:
...
typedef CCoinExtKeyBase<CExtKey, 74, EM_EXT_SECRET_KEY> CCoinExtKey;
typedef CCoinExtKeyBase<CExtPubKey, 74, EM_EXT_PUBLIC_KEY> CCoinExtPubKey;

#endif // COIN_BASE58_H_
