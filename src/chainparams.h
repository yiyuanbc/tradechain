...
#ifndef COIN_CHAINPARAMS_H_
#define COIN_CHAINPARAMS_H_
...
typedef enum  { 
	...
	EM_TESTNET,         //!< TESTNET
	EM_REGTEST,         //!< REGTEST
	EM_MAX_NETWORK_TYPES//!< EM_MAX_NETWORK_TYPES
}emNetWork ;

typedef enum  {
	EM_PUBKEY_ADDRESS, //!< EM_PUBKEY_ADDRESS
	EM_SCRIPT_ADDRESS, //!< EM_SCRIPT_ADDRESS
	EM_SECRET_KEY,     //!< EM_SECRET_KEY
	EM_EXT_PUBLIC_KEY, //!< EM_EXT_PUBLIC_KEY
	EM_EXT_SECRET_KEY, //!< EM_EXT_SECRET_KEY
	EM_ACC_ADDRESS,    //!< EM_ACC_ADDRESS
	EM_MAX_BASE58_TYPES//!< EM_MAX_BASE58_TYPES
}emBase58Type;
...
inline bool TestNet() {
	...
	return SysCfg().NetworkID() == EM_TESTNET;
}

inline bool RegTest() {
	return SysCfg().NetworkID() == EM_REGTEST;
}
