...
static const int g_sRegAppFuel2FeeForkHeight = 0; 			// 改注册app燃料费为小费高度
static const int g_sBurnRateForkHeight = 0;    		//修改燃烧费率算法
...
static const int g_sBlockTime4AppAccountHeight = (1440 * 365 * 20);  			//在此高度后，改用block时间取代高度操作脚本应用账户
static const int g_sBlockRemainCoinDayHeight 	= 0;  		//此高度之后，用新的剩余币龄算法
