...
#ifndef COIN_PROTOCOL_H_
#define COIN_PROTOCOL_H_
...
class CMessageHeader {
 public:
	CMessageHeader();
	CMessageHeader(const char* pszCommand, unsigned int unMessageSizeIn);
...
class CAddress : public CService {
 public:
	CAddress();
	explicit CAddress(CService cIpIn, uint64_t ullServicesIn = NODE_NETWORK);
	void Init();
