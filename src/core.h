...
static const int64_t g_sMaxMoney = IniCfg().GetCoinInitValue() * COIN;
static const int64_t g_sMaxMoneyRegNet = 5 * g_sMaxMoney;
...
class CBlockHeader {
 public:
    // header
    static const int m_sCurrentVersion = g_sBlockVersion2;
